...
# Local Hellar Core Host to connect to
# If this is set, the node follows a Hellar Core PrivValidator process
core-rpc-host = "{{ .PrivValidator.CoreRPCHost }}"

# Local Hellar Core RPC Username
core-rpc-username = "{{ .PrivValidator.CoreRPCUsername }}"

# Local Hellar Core RPC Password
