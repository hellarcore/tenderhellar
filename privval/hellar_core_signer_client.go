...
// HellarCoreSignerClient implements HellarPrivValidator.
...
var _ HellarPrivValidator = (*HellarCoreSignerClient)(nil)

// NewHellarCoreSignerClient returns an instance of SignerClient.
...
func NewHellarCoreSignerClient(
	...
	return &HellarCoreSignerClient{
		logger:            logger,
		hellarCoreRPCClient: client,
...
func (sc *HellarCoreSignerClient) Close() error {
	err := sc.hellarCoreRPCClient.Close()
	if err != nil {
		return err
	}
	return nil
...
func (sc *HellarCoreSignerClient) ping() error {
	err := sc.hellarCoreRPCClient.Ping()
	if err != nil {
		return err
	}
...
func (sc *HellarCoreSignerClient) ExtractIntoValidator(ctx context.Context, quorumHash crypto.QuorumHash) *types.Validator {
	...
	return &types.Validator{
		PubKey:      pubKey,
		VotingPower: types.DefaultHellarVotingPower,
		ProTxHash:   proTxHash,
	}
}
...
func (sc *HellarCoreSignerClient) GetPubKey(ctx context.Context, quorumHash crypto.QuorumHash) (crypto.PubKey, error) {
	if len(quorumHash.Bytes()) != crypto.DefaultHashSize {
		return nil, fmt.Errorf("quorum hash must be 32 bytes long if requesting public key from hellar core")
	}

	response, err := sc.hellarCoreRPCClient.QuorumInfo(sc.defaultQuorumType, quorumHash)
	if err != nil {
...
func (sc *HellarCoreSignerClient) GetFirstQuorumHash(_ctx context.Context) (crypto.QuorumHash, error) {
	return nil, errors.New("getFirstQuorumHash should not be called on a hellar core signer client")
}
...
func (sc *HellarCoreSignerClient) GetHeight(_ctx context.Context, quorumHash crypto.QuorumHash) (int64, error) {
	return 0, fmt.Errorf("getHeight should not be called on a hellar core signer client %s", quorumHash.String())
}
...
func (sc *HellarCoreSignerClient) GetProTxHash(_ctx context.Context) (crypto.ProTxHash, error) {
	...
	masternodeStatus, err := sc.hellarCoreRPCClient.MasternodeStatus()
	if err != nil {
	...
	if len(decodedProTxHash) != crypto.DefaultHashSize {
		...
		networkInfo, err := sc.hellarCoreRPCClient.GetNetworkInfo()
		if err == nil && len(networkInfo.LocalAddresses) > 0 {
			...
			results, err := sc.hellarCoreRPCClient.MasternodeListJSON(localHost)
			if err == nil {
...
func (sc *HellarCoreSignerClient) QuorumVerify(
	...
	return sc.hellarCoreRPCClient.QuorumVerify(quorumType, requestID, messageHash, signature, quorumHash)
}
...
func (sc *HellarCoreSignerClient) HellarRPCClient() hellarcore.Client {
	...
	return sc.hellarCoreRPCClient
}

func (sc *HellarCoreSignerClient) signVoteExtensions(
	ctx context.Context,
	quorumType btcjson.LLMQType,
	quorumHash crypto.QuorumHash,
...
func (sc *HellarCoreSignerClient) quorumSignAndVerify(
	ctx context.Context,
	quorumType btcjson.LLMQType,
	quorumHash crypto.QuorumHash,
...
func (sc *HellarCoreSignerClient) quorumSign(
	...
	resp, err := sc.hellarCoreRPCClient.QuorumSign(quorumType, signItem.ID, signItem.MsgHash, quorumHash)
	if err != nil {
