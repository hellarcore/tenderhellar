...
import (
	...
	"github.com/hellarcore/tenderhellar/rpc/client"
	rpchttp "github.com/hellarcore/tenderhellar/rpc/client/http"
	rpclocal "github.com/hellarcore/tenderhellar/rpc/client/local"
	"github.com/hellarcore/tenderhellar/rpc/coretypes"
	rpcclient "github.com/hellarcore/tenderhellar/rpc/jsonrpc/client"
		...
		t.Run(fmt.Sprintf("%T", c), func(t *testing.T) {
			...
			t.Run("Evidence", func(t *testing.T) {
				t.Run("BroadcastDuplicateVote", func(t *testing.T) {
					...
					require.Equal(t, types.DefaultHellarVotingPower, v.Power, "Stored Power not equal with expected, value %v", string(qres.Value))
