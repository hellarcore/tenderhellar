...
// ErrNoHellarCoreClient means that there is no hellar core client to connect to
var ErrNoHellarCoreClient = errors.New("no hellar core client. please reset light client")
