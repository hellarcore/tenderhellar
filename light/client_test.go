...
import (
	...
	provider_mocks "github.com/hellarcore/tenderhellar/light/provider/mocks"
...
func TestClient(t *testing.T) {
	var (
		...
		hellarCoreMockClient = hellarcore.NewMockClient(chainID, llmqType, privVals[0], true)
	)
