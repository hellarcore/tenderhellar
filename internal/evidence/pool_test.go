...
func TestEvidencePoolUpdate(t *testing.T) {
	...
	block.SetHellarParams(coreChainLockHeight, nil, 0, nil)
...
func initializeValidatorState(
	...
	require.NoError(t, err)
	validator := &types.Validator{VotingPower: types.DefaultHellarVotingPower, PubKey: pubKey, ProTxHash: proTxHash}
