...
import (
	...
	lightprovider "github.com/hellarcore/tenderhellar/light/provider"
	lighthttp "github.com/hellarcore/tenderhellar/light/provider/http"
	lightrpc "github.com/hellarcore/tenderhellar/light/rpc"
	lightdb "github.com/hellarcore/tenderhellar/light/store/db"
...
func NewRPCStateProvider(
	...
	lc, err := light.NewClientAtHeight(ctx, trustHeight, chainID, providers[0], providers[1:],
		lightdb.New(dbm.NewMemDB()), hellarCoreClient, light.Logger(logger))
	if err != nil {
		return nil, err
	}
