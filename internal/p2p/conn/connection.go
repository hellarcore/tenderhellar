...
import (
	...
	"github.com/hellarcore/tenderhellar/internal/libs/flowrate"
	"github.com/hellarcore/tenderhellar/internal/libs/protoio"
	"github.com/hellarcore/tenderhellar/internal/libs/timer"
	...
	tmp2p "github.com/hellarcore/tenderhellar/proto/tendermint/p2p"
)
	...
	for {
		...
		*/
		...
		case *tmp2p.Packet_PacketPing:
			...
			// https://github.com/hellarcore/tenderhellar/issues/1190
			select {
			case c.pong <- struct{}{}:
			default:
				// never block
...
type channel struct {
	...
	// See https://github.com/hellarcore/tenderhellar/issues/7000.
	recentlySent int64
