...
import (
	...
	"github.com/hellarcore/tenderhellar/crypto/merkle"
	...
	statefactory "github.com/hellarcore/tenderhellar/internal/state/test/factory"
	tmstate "github.com/hellarcore/tenderhellar/proto/tendermint/state"
...
func TestOneValidatorChangesSaveLoad(t *testing.T) {
	...
	ctx := hellar.ContextWithProTxHash(context.Background(), firstNode.ProTxHash)
...
func TestProposerPriorityDoesNotGetResetToZero(t *testing.T) {
	...
	val1VotingPower := types.DefaultHellarVotingPower
	...
	val2VotingPower := types.DefaultHellarVotingPower
...
func TestFourAddFourMinusOneGenesisValidators(t *testing.T) {
	...
	ctx := hellar.ContextWithProTxHash(context.Background(), val0.ProTxHash)
