...
import (
	...
	abciclientmocks "github.com/hellarcore/tenderhellar/abci/client/mocks"
	abci "github.com/hellarcore/tenderhellar/abci/types"
	abcimocks "github.com/hellarcore/tenderhellar/abci/types/mocks"
	"github.com/hellarcore/tenderhellar/crypto"
	"github.com/hellarcore/tenderhellar/crypto/bls12381"
	"github.com/hellarcore/tenderhellar/crypto/encoding"
	"github.com/hellarcore/tenderhellar/hellar"
	"github.com/hellarcore/tenderhellar/internal/eventbus"
	mpmocks "github.com/hellarcore/tenderhellar/internal/mempool/mocks"
	...
	"github.com/hellarcore/tenderhellar/internal/state/mocks"
	sf "github.com/hellarcore/tenderhellar/internal/state/test/factory"
	...
	"github.com/hellarcore/tenderhellar/libs/rand"
	tmtypes "github.com/hellarcore/tenderhellar/proto/tendermint/types"
...
func TestApplyBlock(t *testing.T) {
	...
	ctx = hellar.ContextWithProTxHash(ctx, nodeProTxHash)
...
func TestFinalizeBlockByzantineValidators(t *testing.T) {
	...
	require.NoError(t, err)
	dve.ValidatorPower = types.DefaultHellarVotingPower
	...
	abciMb := []abci.Misbehavior{
		{
			...
			TotalVotingPower: types.DefaultHellarVotingPower,
		},
	}
	...
	block, err := sf.MakeBlock(state, 1, new(types.Commit), 1)
	block.SetHellarParams(0, nil, block.ProposedAppVersion, nil)
	require.NoError(t, err)
	block.Evidence = ev
...
func TestFinalizeBlockValidatorUpdates(t *testing.T) {
	...
	if assert.NotEmpty(t, event.ValidatorSetUpdates) {
		...
		assert.EqualValues(
			t,
			types.DefaultHellarVotingPower,
