...
import (
	...
	"github.com/hellarcore/tenderhellar/crypto/secp256k1"
...
const (
	...
	ProtocolHellarCore Protocol = "hellarcore"
...
// Node represents a Tenderhellar node in a testnet.
type Node struct {
	Name                         string
	Testnet                      *Testnet
	Mode                         Mode
...
func (n Node) Validate(testnet Testnet) error {
	...
	case ProtocolFile, ProtocolUNIX, ProtocolTCP, ProtocolGRPC, ProtocolHellarCore:
	default:
