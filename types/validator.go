...
import (
	...
	ce "github.com/hellarcore/tenderhellar/crypto/encoding"
...
// The ProTxHash is part of Hellar additions required for BLS threshold signatures
...
func NewTestValidatorGeneratedFromProTxHash(proTxHash crypto.ProTxHash) *Validator {
	return &Validator{
		VotingPower:      DefaultHellarVotingPower,
		ProposerPriority: 0,
		ProTxHash:        proTxHash,
	}
}
...
func NewValidatorDefaultVotingPower(pubKey crypto.PubKey, proTxHash []byte) *Validator {
	return NewValidator(pubKey, DefaultHellarVotingPower, proTxHash, "")
}
