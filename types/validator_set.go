...
const (
	...
	DefaultHellarVotingPower = int64(100)
...
func (vals *ValidatorSet) QuorumVotingPower() int64 {
	return int64(vals.QuorumTypeMemberCount()) * DefaultHellarVotingPower
}
...
func (vals *ValidatorSet) QuorumVotingThresholdPower() int64 {
	return int64(vals.QuorumTypeThresholdCount()) * DefaultHellarVotingPower
}
...
func (vals *ValidatorSet) ABCIEquivalentValidatorUpdates() *abci.ValidatorSetUpdate {
	...
	for i := 0; i < len(vals.Validators); i++ {
		valUpdate := TM2PB.NewValidatorUpdate(vals.Validators[i].PubKey, DefaultHellarVotingPower,
