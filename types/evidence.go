...
import (
	...
	"github.com/hellarcore/tenderhellar/internal/jsontypes"
...
// NewMockDuplicateVoteEvidenceWithValidator assumes voting power to be DefaultHellarVotingPower and
...
func NewMockDuplicateVoteEvidenceWithValidator(
	...
	val := NewValidator(pubKey, DefaultHellarVotingPower, proTxHash, "")
...
// assumes voting power to be DefaultHellarVotingPower and validator to be the only one in the set
