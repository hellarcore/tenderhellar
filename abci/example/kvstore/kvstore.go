...
import (
	...
	types1 "github.com/hellarcore/tenderhellar/proto/tendermint/types"
...
type Application struct {
	...
	// LastCommittedState is last state that was committed by Tenderhellar and finalized with abci.FinalizeBlock()
...
// `params` must be a final struct that should be passed to Tenderhellar in ResponsePrepare/ProcessProposal at `height`.
